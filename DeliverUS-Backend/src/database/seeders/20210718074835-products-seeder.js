...
module.exports = {
    ...
    */
    ...
    await queryInterface.bulkInsert('Products',
      ...
      // Starters id=1
        ...
        { name: 'Grilled tuna', description: 'with salad', price: 4.5, basePrice: 4, image: process.env.PRODUCTS_FOLDER + '/grilledTuna.jpeg', order: 7, availability: true, restaurantId: 1, productCategoryId: 4 },
  ...
  createNProducts: (numProducts, restaurantId) => {
    ...
    for (let i = 0; i < numProducts; i++) {
      productsArray[i] = { name: 'Product #' + i, description: 'Description #' + i, price: i, basePrice: 1, image: process.env.PRODUCTS_FOLDER + '/agua.png', order: i, availability: true, restaurantId, productCategoryId: 5 }
    }
